...
const styles = StyleSheet.create({
    ...
    ongletText: { fontSize: 15, fontWeight: '600', color: '#888888' },
    ...
    editButton: { fontSize: 15, color: '#182D5A', fontWeight: '600' },

    card: {
        backgroundColor: '#ffffff', borderRadius: 16,
        padding: spacing.lg, borderWidth: 1, borderColor: '#EEF2F7',
        shadowColor: '#182D5A',
    ...
    separator: { height: 1, backgroundColor: '#EEF2F7', marginVertical: 4 },
    emptyText: { fontSize: 15, color: '#888888', textAlign: 'center', paddingVertical: 8 },

    infoRow: {
        flexDirection: 'row', justifyContent: 'space-between',
        alignItems: 'center', paddingVertical: 8,
    },
    infoLabel: { fontSize: 13, color: '#888888', flex: 1 },
    infoValue: { fontSize: 13, color: '#1a1a1a', flex: 2, textAlign: 'right' },
    editInput: {
        flex: 2, fontSize: 13, color: '#1a1a1a', textAlign: 'right',
        borderBottomWidth: 1, borderBottomColor: '#EEF2F7', paddingVertical: 2,
    },

    dashboardCard: {
        backgroundColor: '#ffffff', borderRadius: 16,
        borderWidth: 1, borderColor: '#EEF2F7', overflow: 'hidden',
        shadowColor: '#182D5A',
        shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.08,
        shadowRadius: 8,
    ...
    dashboardValeur: { fontSize: 20, fontWeight: 'bold', color: '#182D5A', marginBottom: 3 },
    dashboardLabel: { fontSize: 10, color: '#888888', textAlign: 'center' },
    dashboardDivider: { width: 1, height: 44, backgroundColor: '#EEF2F7' },
    dashboardSeparator: { height: 1, backgroundColor: '#EEF2F7' },
    dashboardMembreRow: {
        flexDirection: 'row', alignItems: 'center',
        gap: 8, paddingVertical: 10, paddingHorizontal: spacing.lg,
    },
    dashboardMembreTexte: { fontSize: 12, color: '#888888' },

    trajetItem: { paddingVertical: 8, gap: 6 },
    trajetItemInfo: { gap: 3 },
    trajetVilles: { fontSize: 14, fontWeight: '600', color: '#1a1a1a' },
    trajetDetails: { fontSize: 12, color: '#888888' },
    trajetBoutons: { flexDirection: 'row', gap: 6, alignItems: 'center', flexWrap: 'wrap' },

    btnIcone: {
        borderWidth: 1, borderColor: '#EEF2F7', borderRadius: 8,
        paddingVertical: 6, paddingHorizontal: 10,
    },
    btnDemarrer: { backgroundColor: '#182D5A', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 10 },
    btnDemarrerText: { color: 'white', fontSize: 12, fontWeight: '600' },
    btnEnCours: { backgroundColor: '#EEF2F7', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 10 },
    btnEnCoursText: { color: '#888888', fontSize: 12 },
    btnTerminer: {
        backgroundColor: '#EEF2F7', borderRadius: 8, paddingVertical: 6,
        paddingHorizontal: 10, borderWidth: 1, borderColor: '#D8E4F0',
    },
    btnTerminerText: { color: '#1a1a1a', fontSize: 12 },
    btnAnnuler: {
        borderWidth: 1, borderColor: '#E52424', borderRadius: 8,
        paddingVertical: 6, paddingHorizontal: 10,
    },
    btnAnnulerText: { color: '#E52424', fontSize: 12 },

    vehiculeItem: {
        flexDirection: 'row', justifyContent: 'space-between',
        alignItems: 'center', paddingVertical: 8,
    },
    vehiculeNom: { fontSize: 14, fontWeight: '600', color: '#1a1a1a' },
    vehiculeDetails: { fontSize: 12, color: '#888888', marginTop: 2 },
    ...
    navLabel: { fontSize: 14, color: '#1a1a1a' },

    sousListe: {
        backgroundColor: '#EEF2F7', borderRadius: radius.sm,
    ...
    avisDate: { fontSize: 11, color: '#888888', marginTop: 1 },
    avisCommentaire: { fontSize: 13, color: '#888888', fontStyle: 'italic', lineHeight: 18 },
    avisSansCommentaire: { fontSize: 12, color: '#cccccc', fontStyle: 'italic' },
    ...
    voirPlusText: { fontSize: 13, color: '#182D5A', fontWeight: '600' },
    modalTitle: { fontSize: 16, fontWeight: 'bold', color: '#1a1a1a' },
    modalSubtitle: { fontSize: 12, color: '#888888', marginTop: 3 },
    modalVide: { alignItems: 'center', paddingVertical: 32, gap: 8 },
    modalVideText: { color: '#888888', fontSize: 14 },

    passagerCard: {
        flexDirection: 'row', alignItems: 'center', gap: 12,
        backgroundColor: '#EEF2F7', borderRadius: radius.sm, padding: 10, marginBottom: 8,
    },
    ...
    passagerInitiales: { color: '#182D5A', fontSize: 14, fontWeight: '700' },
    passagerInfos: { flex: 1 },
    passagerNom: { color: '#1a1a1a', fontSize: 14, fontWeight: '600' },
    passagerDetail: { color: '#888888', fontSize: 12, marginTop: 2 },
    passagerBtnChat: {
        padding: 6, backgroundColor: '#ffffff',
        borderRadius: 16, borderWidth: 1, borderColor: '#D8E4F0',
    },
});