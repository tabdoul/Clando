...
export const routes: Routes = [
    ...
    { path: 'cgu', loadComponent: () => import('./features/cgu/cgu').then(m => m.CguComponent) },
    { path: 'cgv', loadComponent: () => import('./features/cgv/cgv').then(m => m.CgvComponent) },
    { path: 'confidentialite', loadComponent: () => import('./features/confidentialite/confidentialite').then(m => m.ConfidentialiteComponent) },
